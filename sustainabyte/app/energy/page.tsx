          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {[
              ...
              },
              {
                ...
                desc: "Implement ISO-aligned systems and digital tracking to sustain long-term efficiency.",
                href: "/energy/management-solutions",
                img: "/energy/Energy Management Solutions/Energy-Management-Solutions-BG.webp",
