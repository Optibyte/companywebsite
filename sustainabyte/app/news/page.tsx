...
const newsItems = [
  {
    id: 1,
    publishedBy: "AI Arabia Center of Excellence",
    date: "February 2026",
    title: "Prioritise High-ROI AI Use Cases That Fund Future Innovation",
    excerpt: "Economic diversification succeeds when AI investments generate measurable business value before expanding into broader transformation initiatives. Rather than pursuing technology for its own sake, organisations should first identify practical applications that deliver immediate operational improvements, clear financial returns, and demonstrable productivity gains. Energy efficiency, industrial optimisation, predictive maintenance, and intelligent resource management represent ideal starting points because they reduce costs while improving environmental performance. Early successes build confidence among investors, encourage wider adoption across industry, and establish evidence that AI creates tangible economic outcomes rather than speculative promise.",
    image: "/News/ai-arabia-excellence.jpg",
    href: "#",
  },
  {
    id: 2,
    ...
    date: "January 2026",
    title: "Sustainabyte.ai to showcase AI-driven transformation at IRIS 2026 & DeepTech Summit",
