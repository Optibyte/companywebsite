...
export default function ProblemSolution() {
  return (
    <section id="problem-solution" className="py-24 sm:py-32 bg-[#0B1E3D] relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none opacity-[0.04]"
        style={{ backgroundImage: "linear-gradient(#fff 1px,transparent 1px),linear-gradient(90deg,#fff 1px,transparent 1px)", backgroundSize: "40px 40px" }} />
      <div className="absolute -top-40 -left-40 w-[500px] h-[500px] rounded-full bg-[#193F70]/40 blur-[120px] pointer-events-none" />
      <div className="absolute -bottom-40 -right-20 w-[420px] h-[420px] rounded-full bg-[#27A37B]/20 blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16 sm:mb-20">
          ...
          <motion.h2 initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.65, delay: 0.1 }}
            className="font-[family-name:var(--font-sora)] text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-5 leading-tight">
          ...
          <motion.p initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.65, delay: 0.2 }}
            className="text-white/60 text-lg sm:text-xl max-w-2xl mx-auto font-[family-name:var(--font-dm-sans)]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
          <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-60px" }}
            className="bg-white/5 border border-white/10 rounded-3xl p-8 sm:p-10 backdrop-blur-sm flex flex-col h-full">
            <div className="flex items-center gap-3 mb-8">
              <div className="w-2 h-8 rounded-full bg-red-500/70" />
              <h3 className="font-[family-name:var(--font-sora)] text-xl sm:text-2xl font-bold text-white">The Problem</h3>
            </div>
            <p className="text-white/50 text-sm font-[family-name:var(--font-dm-sans)] mb-8 leading-relaxed">
              ...
              {problemItems.map((item) => {
                ...
                return (
                  <motion.li key={item.label} variants={itemVariants} className="flex items-start gap-4 group">
                    <div className="w-10 h-10 rounded-xl bg-red-500/10 border border-red-500/20 flex items-center justify-center flex-shrink-0 mt-0.5 group-hover:bg-red-500/20 transition-colors duration-200">
                      <Icon className="w-5 h-5 text-red-400" />
                    </div>
                    <div>
                      <p className="font-semibold text-white/90 text-sm font-[family-name:var(--font-dm-sans)]">{item.label}</p>
                      <p className="text-white/40 text-xs font-[family-name:var(--font-dm-sans)] mt-0.5">{item.sub}</p>
                    </div>
                  </motion.li>
                );
              })}
            </ul>
            <motion.div variants={itemVariants} className="mt-auto p-4 rounded-2xl bg-red-500/10 border border-red-500/20">
              <p className="text-red-300 text-sm font-[family-name:var(--font-dm-sans)] leading-relaxed">
          ...
          <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-60px" }}
            className="bg-gradient-to-br from-[#193F70]/40 to-[#27A37B]/20 border border-[#27A37B]/30 rounded-3xl p-8 sm:p-10 backdrop-blur-sm flex flex-col h-full">
            <div className="flex items-center gap-3 mb-8">
              <div className="w-2 h-8 rounded-full bg-[#3DD68C]" />
              <h3 className="font-[family-name:var(--font-sora)] text-xl sm:text-2xl font-bold text-white">The Sustainabyte Solution</h3>
            </div>
            <p className="text-white/60 text-sm font-[family-name:var(--font-dm-sans)] mb-8 leading-relaxed">
            ...
            <ul className="space-y-4 mb-8">
              {solutionItems.map((item) => {
                ...
                return (
                  <motion.li key={item.label} variants={itemVariants} className="flex items-start gap-4 group">
                    <div className="w-10 h-10 rounded-xl bg-[#3DD68C]/15 border border-[#3DD68C]/30 flex items-center justify-center flex-shrink-0 mt-0.5 group-hover:bg-[#3DD68C]/25 transition-colors duration-200">
                      <Icon className="w-5 h-5 text-[#3DD68C]" />
                    </div>
                    <div>
                      <p className="font-semibold text-white/90 text-sm font-[family-name:var(--font-dm-sans)]">{item.label}</p>
                      <p className="text-white/50 text-xs font-[family-name:var(--font-dm-sans)] mt-0.5">{item.sub}</p>
                    </div>
                  </motion.li>
                );
              })}
            </ul>
            <motion.div variants={itemVariants} className="mt-auto p-4 rounded-2xl bg-[#3DD68C]/10 border border-[#3DD68C]/25">
              <p className="text-[#3DD68C] text-sm font-[family-name:var(--font-dm-sans)] leading-relaxed">
        ...
        <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          {[
            ...
            <div key={stat.label} className="bg-white/5 border border-white/10 rounded-2xl px-6 py-6 backdrop-blur-sm">
              <p className="font-[family-name:var(--font-sora)] text-3xl sm:text-4xl font-black text-[#3DD68C] mb-2">{stat.value}</p>
              <p className="text-white/50 text-sm font-[family-name:var(--font-dm-sans)]">{stat.label}</p>
            </div>
          ))}
        </motion.div>
      </div>
